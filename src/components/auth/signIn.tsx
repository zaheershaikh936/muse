...
export default function SignIn({ onChangeAuthMode }: InputProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 h-[45rem] w-full">
      <div className="text-center bg-primary text-primary-foreground p-8 flex flex-col justify-center items-start gap-6">
        <h2 className="text-4xl font-bold">Hello, Learning Partners</h2>
        <p>
          Welcome to the Future of Mentorship! Sign up today and start your
